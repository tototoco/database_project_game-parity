<?php
    ...
    *, *::before, *::after { box-sizing: inherit; }
    ...
    <body background="https://i.ibb.co/CsMxYy0/tDQMOc.jpg">
        ...
        <br></br>
        <div  id="shadowbox">
            <form action="http://localhost/search_sell.php" method="post">
            搜尋：<input type="text" name="Platform" class="light-table-filter" data-table="order-table" placeholder="請輸入關鍵字">

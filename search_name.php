...
include "db_conn.php" ;
    ...
    $error = $stmt->execute(array($game_name));
    ...
    *, *::before, *::after { box-sizing: inherit; }
    ...
    <body background="https://i.ibb.co/CsMxYy0/tDQMOc.jpg">
        ...
        <br></br>
        <div  id="shadowbox">
            <form action="http://localhost/search_name.php" method="post">
            搜尋：<input type="text" name="Name" class="light-table-filter" data-table="order-table" placeholder="請輸入關鍵字">
